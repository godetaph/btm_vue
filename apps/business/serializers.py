...
class BusinessSerializer(serializers.ModelSerializer):
    ...
    qrcode=serializers.PrimaryKeyRelatedField(queryset=Qrcode.objects.all())
    qrcode_url=serializers.ImageField(source='qrcode.qrcode_image', read_only=True)
...
class BusinessPeriodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # read_only_fields=()
        fields=("id", "period", "business", "comment", "business_name", "business_owner", "barangay", "purok", "permit", "created_by", "collector","period_year","created_on",)
